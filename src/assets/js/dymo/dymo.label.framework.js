...
(function () {
  ...
  function ua(a) {
    if (!va.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(wa, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(xa, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(ya, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(za, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(Aa, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(Ca, "&#0;"));
    return a
  }
  var wa = /&/g,
    xa = /</g,
  ...
  var D = Array.prototype,
    ...
    Ia = D.forEach ? function (a, b, d) {
      ...
      for (var e = a.length, f = r(a) ? a.split("") : a, g = 0; g < e; g++) g in f && b.call(d, f[g], g, a)
    },
  ...
  function Ya(a, b) {
    for (var d, e, f = 1; f < arguments.length; f++) {
      e = arguments[f];
      for (d in e) a[d] = e[d];
      for (var g = 0; g < Xa.length; g++) d = Xa[g], Object.prototype.hasOwnProperty.call(e, d) && (a[d] = e[d])
    }
  }
  ...
  function fc(a, b, d) {
    if (!(a.nodeName in cc))
      ...
      for (a = a.firstChild; a;) fc(a, b, d), a = a.nextSibling
  }
  ...
  function zc(a, b, d) {
    if (a.c == xc) {
      if (a == d) b = L, d = new TypeError("Promise cannot resolve to itself");
      else {
        if (hc(d)) {
          a.c = 1;
          Gc(d, a.u, a.B, a);
  ...
  K.prototype.D = function () {
    for (var a = null; a = Lc(this);) Mc(this, a, this.c, this.s);
    this.m = !1
  };
  ...
  function fd(a, b, d, e, f, g) {
    ...
    b = a.c[h];
    b || (b = a.c[h] = [], a.f++);
    var k = gd(b, d, f, g); - 1 < k ? (a = b[k], e || (a.Z = !1)) : (a = new cd(d, a.src, h, !!f, g), a.Z = e, b.push(a));
    return a
  }
  ...
  function id(a) {
    var b = 0,
      d;
    for (d in a.c) {
      for (var e = a.c[d], f = 0; f < e.length; f++) ++b, dd(e[f]);
      delete a.c[d];
      a.f--
    }
  }
  ...
  function md(a, b, d, e, f) {
    if (p(b))
      for (var g = 0; g < b.length; g++) md(a, b[g], d, e, f);
    else if (d = nd(d), a && a[ad]) fd(a.C, String(b), d, !1, e, f);
    else {
      ...
      if (!d.c) {
        ...
        e.src = a;
        e.listener = d;
        if (a.addEventListener) a.addEventListener(b.toString(), e, g);
        else if (a.attachEvent) a.attachEvent(qd(b.toString()), e);
  ...
  function sd(a, b, d, e, f) {
    if (p(b))
      for (var g = 0; g < b.length; g++) sd(a, b[g], d, e, f);
  ...
  function rd(a, b) {
    ...
    if (!Vc) {
      ...
      if (!(0 > d.keyCode || void 0 != d.returnValue)) {
        ...
        d = [];
        for (g = e.c; g; g = g.parentNode) d.push(g);
        for (var g = a.type, k = d.length - 1; 0 <= k; k--) {
          e.c = d[k];
          var l = ud(d[k], g, !0, e),
            f = f && l
        }
        for (k = 0; k < d.length; k++) e.c = d[k],
        l = ud(d[k], g, !1, e),
        f = f && l
      }
      return f
  ...
  function N(a, b) {
    var d, e = a.ga;
    if (e)
      for (d = []; e; e = e.ga) d.push(e);
    var e = a.Ba,
      f = b,
      g = f.type || f;
    if (r(f)) f = new Xc(f, e);
    else if (f instanceof Xc) f.target = f.target || e;
    else {
      var h = f,
        f = new Xc(g, e);
      Ya(f, h)
    ...
    var h = !0,
      k;
    if (d)
      for (var l = d.length - 1; 0 <= l; l--) k = f.c = d[l], h = xd(k, g, !0, f) && h;
    k = f.c = e;
    h = xd(k, g, !0, f) && h;
    h = xd(k, g, !1, f) && h;
    if (d)
      for (l = 0; l < d.length; l++) k = f.c = d[l], h = xd(k, g, !1, f) && h
  }
    ...
    if (null == b) d.push("null");
      ...
      if ("object" == typeof b) {
        if (p(b)) {
          ...
          b = e.length;
          d.push("[");
          for (var f = "", g = 0; g < b; g++) d.push(f), Ad(a, e[g], d), f = ",";
          d.push("]");
          return
        }
        if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
          ...
          d.push("{");
          f = "";
          for (e in b) Object.prototype.hasOwnProperty.call(b, e) && (g = b[e], "function" != typeof g && (d.push(f), Cd(e, d), d.push(":"), Ad(a, g, d), f = ","));
          d.push("}");
          return
        }
      }
  ...
  function Gd(a, b) {
    if ("function" == typeof a.forEach) a.forEach(b, void 0);
    else if (ga(a) || r(a)) Ia(a, b, void 0);
    else {
      var d;
      ...
      for (var e = Fd(a), f = e.length, g = 0; g < f; g++) b.call(void 0, e[g], d && d[g], a)
    }
  };
  ...
  function Hd(a, b) {
    ...
    if (1 < d) {
      ...
      for (var e = 0; e < d; e += 2) Id(this, arguments[e], arguments[e + 1])
    } else if (a) {
      a instanceof Hd ? (d = a.J(), e = a.K()) : (d = Wa(a), e = Va(a));
      for (var f = 0; f < d.length; f++) Id(this, d[f], e[f])
    }
  }
  m = Hd.prototype;
  m.K = function () {
  ...
  function Jd(a) {
    ...
    if (a.h != a.c.length) {
      for (var f = {}, d = b = 0; b < a.c.length;) e = a.c[b], Kd(f, e) || (a.c[d++] = e, f[e] = 1), b++;
      a.c.length = d
    }
  }
  ...
  function Nd(a, b) {
    var d = [];
    if (0 <= Ha(b, a)) d.push("[...circular reference...]");
  ...
  Sd.prototype.log = function (a, b, d) {
    if (a.value >= $d(this).value)
      for (t(b) && (b = b()), a = new Qd(a, String(b), this.i), d && (a.c = d), d = "log:" + a.f, n.console && (n.console.timeStamp ? n.console.timeStamp(d) : n.console.markTimeline && n.console.markTimeline(d)), n.msWriteProfilerMark && n.msWriteProfilerMark(d), d = this; d;) d = d.f
  };
  var ae = {},
    be = null;
  ...
  function Be(a) {
    if (a.h && "undefined" != typeof aa)
      if (a.T[1] && 4 == Ce(a) && 2 == De(a)) P(a.f, ve(a, "Local request error detected and ignored"));
      else if (a.D && 4 == Ce(a)) yd(a.ua, 0, a);
    else if (N(a, "readystatechange"), 4 == Ce(a)) {
      P(a.f, ve(a, "Request complete"));
      a.h = !1;
      try {
        if (a.ba()) N(a, "complete"), N(a, "success");
        else {
          var b;
          try {
  ...
  function Re(a, b) {
    ...
    if (g) Fe(f, e.u);
      ...
      if ("/" != h.charAt(0) && (d.f && !d.h ? h = "/" + h : (d = f.h.lastIndexOf("/"), -1 != d && (h = f.h.substr(0, d + 1) + h))), d = h, ".." == d || "." == d) h = "";
      else if (C(d, "./") || C(d, "/.")) {
  ...
  m.J = function () {
    ...
    for (var a = this.c.K(), b = this.c.J(), d = [], e = 0; e < b.length; e++)
      for (var f = a[e], g = 0; g < f.length; g++) d.push(b[e]);
    return d
  };
  m.K = function (a) {
    Ze(this);
    var b = [];
    if (r(a)) bf(this, a) && (b = Pa(b, Ld(this.c, $e(this, a))));
    else {
      a = this.c.K();
      for (var d = 0; d < a.length; d++) b = Pa(b, a[d])
    }
    return b
  };
  ...
  function jf(a, b, d, e) {
    var f = function () {
        ...
        for (var a = "MSXML2.XmlHttp.6.0 MSXML2.XmlHttp.5.0 MSXML2.XmlHttp.4.0 MSXML2.XmlHttp.3.0 MSXML2.XmlHttp.2.0 Microsoft.XmlHttp".split(" "), b, d = 0; d < a.length; d++) try {
      ...
      h = null,
      k;
    for (k in b) g.push(encodeURIComponent(k) + "=" + encodeURIComponent(b[k]));
  ...
  function lf(a, b) {
    for (var d = [], e = 41951; 41960 >= e; ++e) d.push(mf(e));
  ...
  function T(a, b, d, e) {
    ...
    if (e)
      for (var f in e) b.setAttribute(f, e[f]);
    a.appendChild(b)
  }
  ...
  W.prototype.s = function () {
    for (var a = Ff(this), b = [], d = 0; d < a.length; d++) b.push(wf(U(a[d], "Name")));
    return b
  };
    ...
    for (var h = !0, k = 0; k < g.length; k++) {
      ...
      if (q && q.length) {
        ...
        if (1 != v || h) {
          var y = 0;
          h || (y = 1);
          for (h = U(l, "Attributes"); y < v - 1; y++) f.push(h);
  ...
  */
  ...
  Kf.prototype.cancel = function (a) {
    if (this.c) this.h instanceof Kf && this.h.cancel();
    else {
      if (this.f) {
        var b = this.f;
        delete this.f;
    ...
    if (H && !J("11")) {
      ...
      for (d = f.length; b < d; b++)
        if (g = f[b].value, ec(f[b]) != g) {
          var k = f[b],
            l = g;
          if ("textContent" in k) k.textContent = l;
          else if (3 == k.nodeType) k.data = l;
      ...
      try {
        ...
        try {
          ...
          if (da)
            for (var Sb in da) {
              if (!Mb.test(Sb)) throw Error('Invalid attribute name "' +
                Sb + '".');
              var Ue = da[Sb];
              if (null != Ue) {
                var I = ea,
                ...
                X = Sb;
                u = Ue;
                if (u instanceof nb) u = pb(u);
                else if ("style" == X.toLowerCase()) {
                  E = u;
                  if (!ia(E)) throw Error('The "style" attribute requires goog.html.SafeStyle or map of style properties, ' + typeof E + " given: " + E);
                  if (!(E instanceof rb)) {
                    la = E;
                    d = "";
                    f = void 0;
                  ...
                  if (X.toLowerCase() in Nb)
                    if (u instanceof Eb) u instanceof Eb && u.constructor === Eb && u.c === Fb ? u = "" : (Ga("expected object of type TrustedResourceUrl, got '" + u + "'"), u = "type_error:TrustedResourceUrl");
                    else if (u instanceof wb) u = yb(u);
                  else throw Error('Attribute "' + X + '" on tag "a" requires goog.html.SafeUrl or goog.string.Const value, "' + u + '" given.');
                }
                u.R && (u = u.N());
                Ve = X + '="' + ua(String(u)) + '"';
                ea = I + (" " + Ve)
  ...
  m.G = function () {
    ...
    if (this.L && (P(this.w, "Aborting active request"), this.L)) {
      ...
      var a = ng(this);
      if (a)
        if (a && a[ad]) a.C && id(a.C);
        else if (a = od(a)) {
        var b = 0,
          d;
        for (d in a.c)
          for (var e = a.c[d].concat(), f = 0; f < e.length; ++f) td(e[f]) && ++b
      }
      this.da = this.L = !1;
      N(this, "abort");
      og(this)
    ...
    if (a.isWebServicePresent) {
      ...
      if (f) a = {
        ...
        printLabel2: function (a, b, d, e) {
          if (t(f.printLabel2)) return f.printLabel2(d,
            a, b, e).toString();
          f.printLabel(d, a, b, e)
        },
        getJobStatus: function (a, b) {
  ...
  function Hg(a, b) {
    function d() {
      ...
      if (-1 != b.indexOf("Win"))
        ...
        } else f.ta = !0, xg("application/x-dymolabel") ?
  ...
  function Rg(a) {
    ...
    for (f = 0; f < q.length; f++) {
      var g = b(q[f], "Name"),
        ...
        v =
        "True" == b(q[f], "IsAutoCutSupported"),
        g = new Kg(g, h, k, l, v);
      a[f + d.length] = g;
      a[g.name] = g
    }
    e = e.getElementsByTagName("DZPrinter");
    for (f = 0; f < e.length; f++) g = b(e[f], "Name"), h = b(e[f], "ModelName"), k = "True" == b(e[f], "IsConnected"), l = "True" == b(e[f], "IsLocal"), v = "True" == b(e[f], "IsAutoCutSupported"), g = new Lg(g, h, k, l, v), a[f + d.length] = g, a[g.name] = g;
    return a
  }
  ...
  function Bf(a, b, d, e) {
    ...
    var f = Sg()[a];
    if (null != f) "" != f.c ? Ug(f, b, d, e) : Y().printLabel(f.name, b, d, e);
  ...
  x("dymo.label.framework.renderLabelAsync", function (a, b, d, e) {
    ...
    if (null == e || null != f && "" == f.c) {
      ...
      if (null == f) throw Error("printLabel(): unknown printer '" +
        e + "'");
      var l = ug();
