...
(function () {
  ...
  function ba(a) {
    ...
    for (var b = n, d; d = a.shift();) {
      if (null != b[d]) b = b[d];else return null;
    }
  ...
  var D = Array.prototype,
      Ha = D.indexOf ? function (a, b, d) {
    return D.indexOf.call(a, b, d);
  } : function (a, b, d) {
    d = null == d ? 0 : 0 > d ? Math.max(0, a.length + d) : d;
    if (r(a)) return r(b) && 1 == b.length ? a.indexOf(b, d) : -1;
    ...
    for (var e = a.length, f = r(a) ? a.split("") : a, g = 0; g < e; g++) {
      if (g in f && b.call(d, f[g], g, a)) return !0;
    }
  ...
  ;
  var ab = C(F, "Opera") || C(F, "OPR"),
      H = $a(),
      bb = C(F, "Gecko") && !(C(F.toLowerCase(), "webkit") && !G()) && !(C(F, "Trident") || C(F, "MSIE")) && !G(),
      cb = C(F.toLowerCase(), "webkit") && !G();

  function db() {
    var a = F;
    if (bb) return /rv\:([^\);]+)(\)|;)/.exec(a);
    if (H && G()) return /Edge\/([\d\.]+)/.exec(a);
    ...
    if (!(b = gb[a])) {
      ...
      for (var d = ta(String(fb)).split("."), e = ta(String(a)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == b && g < f; g++) {
        ...
        do {
          var v = l.exec(h) || ["", "", ""],
              y = q.exec(k) || ["", "", ""];
          if (0 == v[0].length && 0 == y[0].length) break;
  ...
  var hb = n.document,
      ib = eb(),
      jb = !hb || !H || !ib && G() ? void 0 : ib || ("CSS1Compat" == hb.compatMode ? parseInt(fb, 10) : 5);
  var kb = !H || H && (G() || 9 <= jb);
  ...
  function pb(a) {
    if (a instanceof nb && a.constructor === nb && a.f === ob) return a.c;
  ...
  function yb(a) {
    if (a instanceof wb && a.constructor === wb && a.f === xb) return a.c;
  ...
  function Ib(a) {
    if (a instanceof Gb && a.constructor === Gb && a.h === Hb) return a.c;
  ...
  function bc(a, b, d, e) {
    if (null != a) for (a = a.firstChild; a;) {
      if (b(a) && (d.push(a), e) || bc(a, b, d, e)) return !0;
      a = a.nextSibling;
    }
    return !1;
  }
  ...
  function rc() {
    ...
    "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !C(F, "Presto") && (a = function a() {
  ...
  function zc(a, b, d) {
    if (a.c == xc) {
      if (a == d) b = L, d = new TypeError("Promise cannot resolve to itself");else {
        if (hc(d)) {
          a.c = 1;
          Gc(d, a.u, a.B, a);
          return;
  ...
  function Mc(a, b, d, e) {
    if (d == L && b.f && !b.l) for (; a && a.l; a = a.h) {
      a.l = !1;
    }
    if (b.c) b.c.h = null, Qc(b, d, e);else try {
  ...
  function gd(a, b, d, e) {
    for (var f = 0; f < a.length; ++f) {
      var g = a[f];
      if (!g.V && g.listener == b && g.$ == !!d && g.aa == e) return f;
    }
  ...
  function md(a, b, d, e, f) {
    if (p(b)) for (var g = 0; g < b.length; g++) {
      md(a, b[g], d, e, f);
    } else if (d = nd(d), a && a[ad]) fd(a.C, String(b), d, !1, e, f);else {
      ...
      if (!d.c) {
        ...
        e.src = a;
        e.listener = d;
        if (a.addEventListener) a.addEventListener(b.toString(), e, g);else if (a.attachEvent) a.attachEvent(qd(b.toString()), e);else throw Error("addEventListener and attachEvent are unavailable.");
        ld++;
      }
    }
  }
  ...
  function sd(a, b, d, e, f) {
    if (p(b)) for (var g = 0; g < b.length; g++) {
      sd(a, b[g], d, e, f);
    } else (d = nd(d), a && a[ad]) ? (a = a.C, b = String(b).toString(), b in a.c && (g = a.c[b], d = gd(g, d, e, f), -1 < d && (dd(g[d]), D.splice.call(g, d, 1), 0 == g.length && (delete a.c[b], a.f--)))) : a && (a = od(a)) && (b = a.c[b.toString()], a = -1, b && (a = gd(b, d, !!e, f)), (d = -1 < a ? b[a] : null) && td(d));
  }

  function td(a) {
    if (ha(a) || !a || a.V) return !1;
    var b = a.src;
    if (b && b[ad]) return hd(b.C, a);
    var d = a.type,
        e = a.c;
  ...
  function ud(a, b, d, e) {
    var f = !0;
    if (a = od(a)) if (b = a.c[b.toString()]) for (b = b.concat(), a = 0; a < b.length; a++) {
      var g = b[a];
  ...
  function N(a, b) {
    ...
    var e = a.Ba,
        f = b,
        g = f.type || f;
    if (r(f)) f = new Xc(f, e);else if (f instanceof Xc) f.target = f.target || e;else {
      var h = f,
          f = new Xc(g, e);
      Ya(f, h);
    }
    var h = !0,
        k;
    if (d) for (var l = d.length - 1; 0 <= l; l--) {
  ...
  function yd(a, b, d) {
    if (t(a)) d && (a = w(a, d));else if (a && "function" == typeof a.handleEvent) a = w(a.handleEvent, a);else throw Error("Invalid listener argument");
  ...
  function Fd(a) {
    if ("function" == typeof a.K) return a.K();
  ...
  function Gd(a, b) {
    if ("function" == typeof a.forEach) a.forEach(b, void 0);else if (ga(a) || r(a)) Ia(a, b, void 0);else {
      var d;
      if ("function" == typeof a.J) d = a.J();else if ("function" != typeof a.K) {
        if (ga(a) || r(a)) {
          d = [];
  ...
  function Nd(a, b) {
    var d = [];
    if (0 <= Ha(b, a)) d.push("[...circular reference...]");else if (a && 50 > b.length) {
      d.push(Od(a) + "(");
  ...
  var Ud = new Td("SEVERE", 1E3),
      Vd = new Td("WARNING", 900),
      Wd = new Td("INFO", 800),
      Xd = new Td("CONFIG", 700),
      Yd = new Td("FINE", 500),
      Zd = new Td("FINER", 400);
  ...
  Sd.prototype.log = function (a, b, d) {
    if (a.value >= $d(this).value) for (t(b) && (b = b()), a = new Qd(a, String(b), this.i), d && (a.c = d), d = "log:" + a.f, n.console && (n.console.timeStamp ? n.console.timeStamp(d) : n.console.markTimeline && n.console.markTimeline(d)), n.msWriteProfilerMark && n.msWriteProfilerMark(d), d = this; d;) {
      d = d.f;
    }
  };
  ...
  function le(a) {
    if (me) {
      ...
      if (b) {
        var d = b.href;
        if (d && (d = (d = le(d)[3] || null) ? decodeURI(d) : d) && d != b.hostname) throw me = !0, Error();
      }
    }
  ...
  m.send = function (a, b, d, e) {
    if (this.c) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.B + "; newUri=" + a);
    ...
    try {
      xe(this), 0 < this.l && (this.I = ye(this.c), P(this.f, ve(this, "Will abort after " + this.l + "ms if incomplete, xhr2 " + this.I)), this.I ? (this.c.timeout = this.l, this.c.ontimeout = w(this.S, this)) : this.F = yd(this.S, this.l, this)), P(this.f, ve(this, "Sending request")), this.D = !0, this.c.send(a), this.D = !1;
    } catch (h) {
  ...
  function Be(a) {
    if (a.h && "undefined" != typeof aa) if (a.T[1] && 4 == Ce(a) && 2 == De(a)) P(a.f, ve(a, "Local request error detected and ignored"));else if (a.D && 4 == Ce(a)) yd(a.ua, 0, a);else if (N(a, "readystatechange"), 4 == Ce(a)) {
      P(a.f, ve(a, "Request complete"));
      a.h = !1;

      try {
        if (a.ba()) N(a, "complete"), N(a, "success");else {
          var b;
  ...
  m.ba = function () {
    ...
    if (!b) {
      if (a = 0 === a) a = le(String(this.B))[1] || null, !a && self.location && (a = self.location.protocol, a = a.substr(0, a.length - 1)), a = !re.test(a ? a.toLowerCase() : "");
      b = a;
    }
  ...
  Q.prototype.toString = function () {
    ...
    if (b = this.h) this.f && "/" != b.charAt(0) && a.push("/"), a.push(Je(b, "/" == b.charAt(0) ? Le : Me, !0));
  ...
  function Re(a, b) {
    ...
    var h = e.h;
    if (g) Fe(f, e.u);else if (g = !!e.h) if ("/" != h.charAt(0) && (d.f && !d.h ? h = "/" + h : (d = f.h.lastIndexOf("/"), -1 != d && (h = f.h.substr(0, d + 1) + h))), d = h, ".." == d || "." == d) h = "";else if (C(d, "./") || C(d, "/.")) {
      for (var h = 0 == d.lastIndexOf("/", 0), d = d.split("/"), k = [], l = 0; l < d.length;) {
        var q = d[l++];
        "." == q ? h && l == d.length && k.push("") : ".." == q ? ((1 < k.length || 1 == k.length && "" != k[0]) && k.pop(), h && l == d.length && k.push("")) : (k.push(q), h = !0);
      }
  ...
  m.K = function (a) {
    Ze(this);
    var b = [];
    if (r(a)) bf(this, a) && (b = Pa(b, Ld(this.c, $e(this, a))));else {
      a = this.c.K();
  ...
  function jf(a, b, d, e) {
    ...
    f.send(h);
    if (200 != f.status) throw Error("Failed to execute webservice command: " + f.status + ": " + f.statusText);
    return f.responseText;
  }

  function kf(a) {
    try {
      return "true" === jf("https://localhost:" + a + "/DYMO/DLS/Printing/StatusConnected", {}, "GET", function () {});
    } catch (b) {
      return !1;
    }
  }
  ...
  function nf(a, b, d) {
    var e = hf();
    a = jf("https://localhost:" + e + "/DYMO/DLS/Printing/" + b, d, a, function () {});
  ...
  function If(a, b, d) {
    ...
    for (k = 0; k < d.length; k++) {
      y = d[k].replace("\r", ""), k < d.length - 1 && (y += "\n"), h = B, 0 < b.length ? h = k < b.length ? b[k] : b[b.length - 1] : 0 < f.length && (h = k < f.length ? U(f[k], "Font") : U(f[f.length - 1], "Font")), l = g, k < f.length && (l = U(f[k], "ForeColor")), q = e.ownerDocument.createElement("Element"), v = e.ownerDocument.createElement("String"), xf(v, y), y = e.ownerDocument.createElement("Attributes"), y.appendChild(h.cloneNode(!0)), y.appendChild(l.cloneNode(!0)), q.appendChild(v), q.appendChild(y), e.appendChild(q);
    }
    ...
    switch (d.tagName) {
      ...
      case "ImageObject":
        ...
        if (e) xf(e, b);else {
          ...
          if (!f) throw Error("setObjectText(): <ImageLocation> is expected but not found: " + vf(e));
  ...
  */
  ...
  Kf.prototype.cancel = function (a) {
    if (this.c) this.h instanceof Kf && this.h.cancel();else {
      if (this.f) {
        var b = this.f;
        delete this.f;
  ...
  function Of(a) {
    ...
    for (var b = a.h, e = d = !1; a.l.length && !a.s;) {
      ...
      if (g = a.i ? h : g) try {
        ...
        if (hc(b) || "function" === typeof n.Promise && b instanceof n.Promise) e = !0, a.s = !0;
      } catch (l) {
        b = l, a.i = !0, Rf(a) || (d = !0);
      }
    }
  ...
  function Uf(a, b) {
    var d = b || {},
      ...
      S: void 0
        ...
        h = new Kf(Vf, g),
        k = null,
        l = null != d.timeout ? d.timeout : 5E3;
    ...
    f.onerror = function () {
      Wf(f, !0, k);
      var b = new Xf(Zf, "Error while loading script " + a);
      Mf(h);
      Nf(h, !1, b);
    };
  ...
  m.send = function (a, b, d, e) {
    if (this.L) throw Error("[goog.net.IframeIo] Unable to send, already active.");
    this.ia = a = new Q(a);
    b = b ? b.toUpperCase() : "GET";
    ...
    ig || (ig = Vb("FORM"), ig.acceptCharset = "utf-8", d = ig.style, d.position = "absolute", d.visibility = "hidden", d.top = d.left = "-10px", d.width = d.height = "10px", d.overflow = "hidden", document.body.appendChild(ig));
    this.o = ig;
    "GET" == b && kg(this.o, a.c);
    e && kg(this.o, e);
    ...
    e.display = "none";
    cb ? e.marginTop = e.marginLeft = "-10px" : (e.position = "absolute", e.top = e.left = "-10px");
    ...
    if (H && !J("11")) {
      ...
      e = this.P + "_inner";
      a = $b(this.v);
      document.baseURI ? (b = ua(e), qb("Short HTML snippet, input escaped, safe URL, for performance"), b = '<head><base href="' + ua(document.baseURI) + '"></head><body><iframe id="' + b + '" name="' + b + '"></iframe>', b = Kb(b, null)) : (b = ua(e), qb("Short HTML snippet, input escaped, for performance"), b = Kb('<body><iframe id="' + b + '" name="' + b + '"></iframe>', null));
      ...
      for (d = f.length; b < d; b++) {
        if (g = f[b].value, ec(f[b]) != g) {
          var k = f[b],
              l = g;
          if ("textContent" in k) k.textContent = l;else if (3 == k.nodeType) k.data = l;else if (k.firstChild && 3 == k.firstChild.nodeType) {
            for (; k.lastChild != k.firstChild;) {
              k.removeChild(k.lastChild);
            }

            k.firstChild.data = l;
          } else Zb(k), k.appendChild((9 == k.nodeType ? k : k.ownerDocument || k.document).createTextNode(String(l)));
          f[b].value = g;
        }
      }
      ...
      for (d = g.length; b < d; b++) {
        for (var l = g[b].getElementsByTagName("OPTION"), q = k[b].getElementsByTagName("OPTION"), v = 0, y = l.length; v < y; v++) {
      ...
      try {
        ...
        try {
          ...
          if (/^https?:\/\//i.test(E)) {
            var ka;
            I = E;
            I instanceof wb ? ka = I : (I = I.R ? I.N() : String(I), I = zb.test(I) ? Ab(I) : "about:invalid#zClosurez", ka = Db(I));
          ...
          var Sa = Ba.fileName;
          if (!Mb.test("a")) throw Error("Invalid tag name <a>.");
          if ("A" in Ob) throw Error("Tag name <a> is not allowed for SafeHtml.");
          ka = null;
          ea = "<a";
          if (da) for (var Sb in da) {
            if (!Mb.test(Sb)) throw Error('Invalid attribute name "' + Sb + '".');
            var Ue = da[Sb];
            ...
            if (null != Ue) {
              ...
              X = Sb;
              u = Ue;
              if (u instanceof nb) u = pb(u);else if ("style" == X.toLowerCase()) {
                E = u;
                if (!ia(E)) throw Error('The "style" attribute requires goog.html.SafeStyle or map of style properties, ' + _typeof(E) + " given: " + E);
                ...
                if (!(E instanceof rb)) {
                  ...
                  for (f in la) {
                    ...
                    if (null != O) {
                      if (O instanceof nb) O = pb(O);else if (vb.test(O)) {
                        k = g = !0;
                      ...
                      } else Ga("String value allows only [-,.\"'%_!# a-zA-Z0-9], got: " + O), O = "zClosurez";
                      d += f + ":" + O + ";";
                    }
                  }
                ...
                if (/^on/i.test(X)) throw Error('Attribute "' + X + '" requires goog.string.Const value, "' + u + '" given.');
                if (X.toLowerCase() in Nb) if (u instanceof Eb) u instanceof Eb && u.constructor === Eb && u.c === Fb ? u = "" : (Ga("expected object of type TrustedResourceUrl, got '" + u + "'"), u = "type_error:TrustedResourceUrl");else if (u instanceof wb) u = yb(u);else throw Error('Attribute "' + X + '" on tag "a" requires goog.html.SafeUrl or goog.string.Const value, "' + u + '" given.');
              }
              u.R && (u = u.N());
              Ve = X + '="' + ua(String(u)) + '"';
              ea = I + (" " + Ve);
          ...
          var Ye = da && da.dir;
          Ye && (/^(ltr|rtl|auto)$/i.test(Ye) ? ka = 0 : ka = null);
          Te = Kb(ea, ka);
          mb = Pb(Pg, Te, Lb("\nLine: " + Ba.lineNumber + "\n\nBrowser stack:\n" + Ba.stack + "-> [end]\n\nJS stack traversal:\n" + Md(void 0) + "-> "));
        } catch (Qg) {
  ...
  m.G = function () {
    ...
    if (this.L && (P(this.w, "Aborting active request"), this.L)) {
      ...
      var a = ng(this);
      if (a) if (a && a[ad]) a.C && id(a.C);else if (a = od(a)) {
        var b = 0,
            d;
  ...
  function Dg() {
    ...
    if ("object" != _typeof(a)) throw Error("createFramework(): unable to create DYMO.Label.Framework object. Check DYMO Label Framework is installed");
    return a;
  }

  function Eg(a) {
    if ("" != a.errorDetails) throw Error(a.M);
    ...
    if (a.isWebServicePresent) {
      ...
      if (b) a = {
        ...
        printLabel: function printLabel(a, d, e, f) {
          b.printLabel(a, d, e, f);
        },
        printLabel2: function printLabel2(a, d, e, f) {
          b.printLabel2(a, d, e, f);
        },
        renderLabel: function renderLabel(a, d, e) {
          return b.renderLabel(a, d, e);
        },
        loadImageAsPngBase64: function loadImageAsPngBase64(a) {
          return b.loadImageAsPngBase64(a);
        },
        getJobStatus: function getJobStatus(a, d) {
          var e;
          t(b.getJobStatus) ? e = wg(b.getJobStatus(a, parseInt(d, 10))) : e = {
            status: R.W,
      ...
      a.printLabel2 = function (a, b, e, f) {
        if (t(d.PrintLabel2)) return d.PrintLabel2(a, b, e, f).toString();
        d.PrintLabel(a, b, e, f);
      };
      ...
      if (e) a = {
        ...
        printLabel: function printLabel(a, b, d, f) {
        ...
        printLabel2: function printLabel2(a, b, d, f) {
      ...
      if (f) a = {
        ...
        printLabel2: function printLabel2(a, b, d, e) {
          if (t(f.printLabel2)) return f.printLabel2(d, a, b, e).toString();
          f.printLabel(d, a, b, e);
        },
        getJobStatus: function getJobStatus(a, b) {
          var d;
  ...
  var Y = function () {
    function a(e, f) {
      if (d) throw Error("DYMO Label Framework service discovery is in progress.");
  ...
  function Hg(a, b) {
    function d() {
      ...
      if (-1 != b.indexOf("Win")) {
        if ("ActiveXObject" in window) {
          ...
          try {
            "object" != _typeof(new ActiveXObject("DYMOLabelFrameworkIEPlugin.Plugin")) ? f.M = "Unable to create DYMO.Label.Framework ActiveX object. Check that DYMO.Label.Framework is installed" : f.ka = !0;
          } catch (d) {
        ...
        } else f.ta = !0, xg("application/x-dymolabel") ? f.ka = !0 : f.M = "DYMO Label Framework Plugin is not installed";
      } else -1 != b.indexOf("Mac") ? (f.ta = !0, xg("application/x-dymolabel") ? (b = yg(), "2.0" <= b.GetAPIVersion() ? f.ka = !0 : f.M = "DYMO Label Safari Plugin is installed but outdated. Install the latest version.") : xg("application/x-npapi-dymolabel") ? (b = Cg()) && b.getPrinters ? f.ka = !0 : f.M = 'DYMO NSAPI plugin is loaded but no callable functions found. If running Safari, then run it in 64-bit mode (MacOS X >= 10.7) or set "Open using Rosetta" option' : f.M = "DYMO Label Plugin is not installed.") : f.M = "The operating system is not supported.";
      a && a(f);
    }
    ...
    if (Fg) return e(), f;
    var g = hf();
    b ? g ? ue("https://localhost:" + g + "/DYMO/DLS/Printing/StatusConnected", function (a) {
  ...
  function Rg(a) {
    ...
    for (var e = U(d, "Printers"), d = e.getElementsByTagName("LabelWriterPrinter"), f = 0; f < d.length; f++) {
      var g = b(d[f], "Name"),
          h = b(d[f], "ModelName"),
          k = "True" == b(d[f], "IsConnected"),
          l = "True" == b(d[f], "IsLocal"),
          q = "True" == b(d[f], "IsTwinTurbo"),
          g = new Jg(g, h, k, l, q);
      a[f] = g;
      a[g.name] = g;
    }
    ...
    for (f = 0; f < q.length; f++) {
      var g = b(q[f], "Name"),
          h = b(q[f], "ModelName"),
          k = "True" == b(q[f], "IsConnected"),
          l = "True" == b(q[f], "IsLocal"),
          v = "True" == b(q[f], "IsAutoCutSupported"),
          g = new Kg(g, h, k, l, v);
      a[f + d.length] = g;
      a[g.name] = g;
    }
  ...
  function Bf(a, b, d, e) {
    ...
    var f = Sg()[a];
    if (null != f) "" != f.c ? Ug(f, b, d, e) : Y().printLabel(f.name, b, d, e);else throw Error("printLabel(): unknown printer '" + a + "'");
  }
  ...
  function Cf(a, b, d, e) {
    ...
    "string" != typeof d && (d = d.toString());
    var f = Sg()[a];
    if (null != f) return "" != f.c ? Ug(f, b, d, e) : new Z(f, Y().printLabel2(a, b, d, e));
  ...
  function Ug(a, b, d, e) {
    function f(a, b) {
      ...
      new ag(h, "c").send({
        ...
        var e = d.status,
            h = new Sd("dymo.label.framework");
        h.c = Wd;
        0 == e ? -1 != a ? f(++a, 0) : h.log(Wd, "Finished sending job payload for " + g, void 0) : -5 == e ? 10 > b ? f(++d.lastAckChunkId, ++b) : h.log(Vd, 'Unable to send print job data for "' + g + '": STATUS_INVALID_CHUNK_ID: Max retry count reached', void 0) : 10 > b ? f(a, ++b) : h.log(Vd, 'Unable to send print job data for "' + g + '": Max retry count reached', void 0);
      }, function () {
  ...
  x("dymo.label.framework.renderLabelAsync", function (a, b, d, e) {
    ...
    if (!b) throw Error("renderLabelAsync(): callback parameter should be specified");
    "string" != typeof a && (a = a.toString());
    d = d || "";
    e = e || "";
    var f = Sg()[e];
    ...
    if (null == e || null != f && "" == f.c) {
      ...
      if (null == f) throw Error("printLabel(): unknown printer '" + e + "'");
      var l = ug();
  ...
  x("dymo.label.framework.createLabelWriterPrintParamsXml", function (a) {
    if (!a) return "";
    var b = S("<LabelWriterPrintParams/>"),
        d = b.documentElement;
  ...
  x("dymo.label.framework.createLabelRenderParamsXml", function (a) {
    ...
    "undefined" != typeof a.pngUseDisplayResolution && T(e, "PngUseDisplayResolution", a.pngUseDisplayResolution ? "True" : "False");
    return vf(d);
  });
})();