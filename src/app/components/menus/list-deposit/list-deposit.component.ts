...
import { CreditMovementsImportedDto } from '../models/CreditMovementImported/credit-movements-imported-dto';
...
export class ListDepositComponent implements OnInit {
  ...
  public showCreditMovementImport: boolean = false;
  public showMsgNoMatchValues: boolean = false;
  creditMovementImportedSelected(entity: CreditMovementsImportedDto) {
  ...
  public changeCreditMovementImportedRow() {
    this.creditMovementsImported = null
    this.showCreditMovementImport = false;
    this.showTableCreditMovementImported = true;
    this.showMsgNoMatchValues = false;
