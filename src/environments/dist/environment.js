...
exports.environment = {
    ...
    mediaTypes: {
        ...
        guide: {
            get: {
                accept: {
                    getAllGuideJson: 'application/vnd.dsalpha.GetGuides+json',
                    getAllGuideXml: 'application/vnd.dsalpha.GetGuides+xml',
                    getAllGuideJsonHateoas: 'application/vnd.dsalpha.GetGuides.hateoas+json'
                }
            },
            getUnique: {
                accept: {
                    getGuideJson: 'application/vnd.dsalpha.GetGuide+json',
                    getGuideXml: 'application/vnd.dsalpha.GetGuide+xml',
                    getGuideJsonHateoas: 'application/vnd.dsalpha.GetGuide.hateoas+json'
                }
            },
            post: {
                ContentType: {
                    postJson: 'application/vnd.dsalpha.createGuide+json',
                    postJsonHateoas: 'application/vnd.dsalpha.createGuide.hateoas+json'
                }
            },
            put: {
                ContentType: {
                    putJson: 'application/vnd.dsalpha.UpdateGuide+json',
                    putJsonHateoas: 'application/vnd.dsalpha.UpdateGuide.hateoas+json'
                }
            },
            patch: {
                ContentType: {
                    putJson: 'application/vnd.dsalpha.guideforPatch+json',
                    putJsonHateoas: 'application/vnd.dsalpha.guideforPatch.hateoas+json'
                }
            }
        }
    }
